...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    private final MyAdapter.ProdutoOnClickListener onClickListener;
    ...
    public MyAdapter(Context context, List<Produto> produtos, MyAdapter.ProdutoOnClickListener onClickListener){
